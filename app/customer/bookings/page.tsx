            ...
            <motion.div variants={fadeIn} className="space-y-6">
                {filteredBookings.length === 0 ? (
                    ...
                    filteredBookings.map((booking) => (
                        <motion.div variants={fadeInUp} key={booking.id}>
                            <Card className="glass-dark border-white/5 overflow-hidden group hover:border-primary/30 transition-all duration-500">
                                        ...
                                        <div className="lg:col-span-2 p-8 border-b lg:border-b-0 lg:border-r border-white/5 relative">
                                            ...
                                            <div className="mb-6">
                                                ...
                                                <div className="flex flex-wrap gap-4 text-sm text-muted-foreground">
                                                    ...
                                                    <span className="flex items-center gap-2 bg-white/5 px-3 py-1.5 rounded-full border border-white/5">
                                                        <MapPin className="w-4 h-4 text-primary" /> {booking.location || 'Location not specified'}
                                                    </span>
                                                </div>
                                            </div>
